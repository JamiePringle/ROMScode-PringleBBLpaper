...
export   ROMS_APPLICATION=JMPBUMP

# Set a local environmental variable to define the path to the directories
# where all this project's files are kept.

#export        MY_ROOT_DIR=${HOME}/workfiles/dPdy/roms_Nov2017 NORMAL CODE FOR LAST PAPER
export        MY_ROOT_DIR=${HOME}/workfiles/dPdy/roms_Sep2018 
...
# compatibility with older versions of the code.
 ...
 export BACK_COMPATIBILITY=off           # needed for ROMS 3.4 or older
